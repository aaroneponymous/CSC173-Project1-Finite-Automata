...
{
    DFA odd0even1 = new_DFA(2);
    DFA_set_accepting(odd0even1, 0, true);
    DFA_set_transition_all(odd0even1, 0, 1);
    DFA_set_transition_all(odd0even1, 1, 1);

    DFA_set_transition(odd0even1, 0, '0', 1);
    DFA_set_transition(odd0even1, 1, '0', 0);
    DFA_set_transition(odd0even1, 0, '1', 0);
    DFA_set_transition(odd0even1, 1, '1', 1);
...
/*    // DFA for 1 2 3 in order Testing
    ...
    // DFA for 1 or 2 or 3 at the start Testing // Needs Work
    str = "23";
    ...
    // DFA for odd 0 even 1 Testing
    // Testing strings
    str = "001110";
    DFA odd0even1 = create_odd_0_even_1();
    printf("False? : %d", DFA_execute(odd0even1, str));
    printf("\n");

    str = "001111"; // Should be false
    printf("\n");
    printf("False? : %d", DFA_execute(odd0even1, str));
    printf("\n");
    str = "0011110"; // Should be true
    printf("\n");
    printf("True? : %d", DFA_execute(odd0even1, str));
    printf("\n");
    str = "0011111"; // Should be false
    printf("\n");
    printf("False? : %d", DFA_execute(odd0even1, str));
    printf("\n");
    str = "00111110"; // Should be true
    printf("True? : %d", DFA_execute(odd0even1, str));
    DFA_free(odd0even1);*/
